...
--                     unfold_projections,
--                     dsimp,
--                     note p := @NaturalTransformation.naturality _ _ _ _ A.morphism (X, L X) (X, L Y) (C.identity X, L.onMorphisms f),--((Opposite C × D).identity (X, L Y)),
...
--                     unfold_projections_hypotheses,
--                     dsimp_hypotheses,
--                     note q := congr_fun p (L.onMorphisms (C.identity X)),
--                     dsimp at q,
